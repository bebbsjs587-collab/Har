...
import { X, Home, Bot, Ruler, Palette, Flame, Trophy, ShieldCheck, ChevronLeft, Wrench, Sparkles, Lock, ArrowRight, BarChart3, LogOut, Film, KeyRound, Unlock } from 'lucide-react';
