...
const DraggableFab: React.FC<DraggableFabProps> = ({ onClick }) => {
  ...
  return (
    ...
    >
      <button className={`w-16 h-16 bg-gold-luxury rounded-full shadow-[0_0_40px_rgba(212,175,55,0.6)] flex items-center justify-center text-black relative transition-transform duration-100 border-2 border-white/20 ${isDragging ? 'scale-110' : 'animate-bounce'}`}>
        <Bot size={32} />
